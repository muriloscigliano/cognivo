...
host { display: inline-flex; align-items: center; padding: 4px 8px; border-radius: ${tokens.radius.full}; font-size: ${tokens.fontSize.xs}; font-weight: ${tokens.fontWeight.medium}; background: ${tokens.color.gray100}; color: ${tokens.color.gray900}; }
