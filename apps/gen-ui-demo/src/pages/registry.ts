...
export const registry: ComponentMeta[] = [
  ...
  },
  {
    ...
    description: 'Multi-line text input with optional auto-resize, character count, size variants, rounded options, and validation states (error/success).',
    props: [
