...
console.log(message);`;
  ...
  if (tag === 'ai-agent-card') { e.name = 'Researcher'; e.agentRole = 'Data Analyst'; e.status = 'thinking'; e.task = 'Querying vector store for Q4 revenue breakdown...'; e.capabilities = ['search', 'summarize', 'RAG']; e.handoffChain = ['Planner', 'Researcher', 'Coder']; }
