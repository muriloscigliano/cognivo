 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const l = globalThis, y = l.ShadowRoot && (l.ShadyCSS === void 0 || l.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, S = Symbol(), $ = /* @__PURE__ */ new WeakMap();
let g = class {
  constructor(t, e, s) {
...
const v = (r) => new g(typeof r == "string" ? r : r + "", void 0, S), w = (r, t) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: P, defineProperty: U, getOwnPropertyDescriptor: C, getOwnPropertyNames: O, getOwnPropertySymbols: A, getPrototypeOf: M } = Object, p = globalThis, _ = p.trustedTypes, R = _ ? _.emptyScript : "", k = p.reactiveElementPolyfillSupport, c = (r, t) => r, d = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? R : null;
      break;
  ...
  return e;
} }, m = (r, t) => !P(r, t), b = { attribute: !0, type: String, converter: d, reflect: !1, useDefault: !1, hasChanged: m };
...
class h extends HTMLElement {
  ...
  requestUpdate(t, e, s) {
    if (t !== void 0) {
      ...
      if (s ??= i.getPropertyOptions(t), !((s.hasChanged ?? m)(o, e) || s.useDefault && s.reflect && o === this._$Ej?.get(t) && !this.hasAttribute(i._$Eu(t, s)))) return;
      this.C(t, e, s);
    }
...
h.elementStyles = [], h.shadowRootOptions = { mode: "open" }, h[c("elementProperties")] = /* @__PURE__ */ new Map(), h[c("finalized")] = /* @__PURE__ */ new Map(), k?.({ ReactiveElement: h }), (p.reactiveElementVersions ??= []).push("2.1.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const z = { attribute: !0, type: String, converter: d, reflect: !1, hasChanged: m }, x = (r = z, t, e) => {
...
function q(r) {
  return (t, e) => typeof e == "object" ? x(r, t, e) : ((s, i, o) => {
...
//# sourceMappingURL=base-Ce59O1a4.js.map
